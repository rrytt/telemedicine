...
class AdminPatientsView extends StatelessWidget {
  ...
  Widget _buildList(AdminController controller) {
    ...
    final results = controller.searchPatients(controller.searchQuery.value);
      ...
      return Center(
        child: Column(
          ...
          children: const <Widget>[
            ...
            SizedBox(height: 12),
            Text('No patients found', style: TextStyle(color: AdminStyles.slate, fontSize: 15)),
          ],
        ),
      );
    }
          ...
          return Container(
            ...
            child: ListTile(
              ...
              leading: CircleAvatar(
                backgroundColor: AdminStyles.blue.withValues(alpha: 0.15),
      ...
      Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Patient Details', style: AdminStyles.sectionHeader),
            const SizedBox(height: 20),
  ...
  void _showEditDialog(
    ...
    final roleController = TextEditingController(text: account.role);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 20),
              Text('Edit Patient', style: AdminStyles.sectionHeader),
              const SizedBox(height: 20),
              TextField(
              ...
              TextField(
                ...
                decoration: AdminStyles.inputDecoration(label: 'Role'),
                readOnly: true,
              ),
              const SizedBox(height: 14),
              Obx(() => Row(
